...
public class Butelka {
    ...
    void przelejPolowe(double ilosc, Butelka doKtorajButelki)
    {
        if (ilosc/2 < (this.ileLitrow) && ilosc/2 <= (this.pojemnoscMax - this.ileLitrow))
        {
            doKtorajButelki.wlej(ilosc/2);
            this.wylej(ilosc/2);
        }
        else
            System.out.println(" Nie ma wystarczająco dużo miejsca w butelce '"+ doKtorajButelki.nazwa + "'. Próba przelania "+ ilosc + " litrów nie powiodła się. Operacja została anulowana.");
